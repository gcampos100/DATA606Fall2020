...
**Decreasing the confidence interval which is what I decreases the error boundaries, and can physically be seen on the boundaries in a normal curve. This in turn makes the confidence interval *NARROWER* than the interval for 95%**

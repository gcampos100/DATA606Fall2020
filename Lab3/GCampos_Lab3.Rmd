...
```{r sim-basket-45}
#Shot outcomes vector already creative above so all that is needed is the manipulation of probability
set.seed(3606)
sim_basket_45 <- sample(shot_outcomes, size = 133, replace = TRUE, 
                          prob = c(0.45, 0.55))
```
...
```{r count-compare}
# I decided to generate
sim_streak <- calc_streak(sim_basket_45$shot)
```

...
## 1.
    ...
    the sample.\newline
\
**The distribution for the sample set is noticeably greater, for number of responses of  *work scientists DO NOT BENEFIT them*. The difference is about 6%.However the distribution on both are clearly right skewed**\newline
...
**No. With *n* being relatively small, we can expect the results to deviate and most likely will not match, but will be nearly the same**
...
**As the value of the sample size *n* increases, the more accurate the estimate becomes. Therefore I believe a sample of *n*=1000 say samp1000 would be most accurate**\newline
**For reference, my simulation proportions of samp100 is `r samp100_p_hat` & samp1000 is `r samp1000_p_hat`.**\newline

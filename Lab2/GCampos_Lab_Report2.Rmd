...
**i)** binwidth = 15 shows departure delays before the peak amount\newline\
**ii)** binwidth = 150 shows a larger count for number of delay flights. Approximately 100 more.
...
Mean is the optimal choice. An average gives a calculated value of a the potential delay for the month. The median is uncalculated and more easily impacted by outliers in the data set for the month (e.g. 1/2013 saw at least one triple digit delay).
...
ggplot(data  = ex9_data, mapping = aes(x = dep_delay, arr_delay, color = carrier))+ geom_point()
```

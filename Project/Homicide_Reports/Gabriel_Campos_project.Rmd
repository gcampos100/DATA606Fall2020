...
* Independence - Murder counts are assumed independent with 53072 observations$\checkmark$
...
being composed of only 2 states, and the fact that it both follow national trends indicating peak numbers\newline
occur for victims 20-30, I would saw the difference is most likely because of population size. If I were to\newline
do a comparison of population of these regions during these years, I'd imagine the murder counts would be\newline
comparable. Regardless the data does not highlight any specific region in my opinion, but does imply age is\newline
is the biggest factor among those mentions, impacting murder count.\newline
